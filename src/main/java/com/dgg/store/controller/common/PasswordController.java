...
public class PasswordController
{
     ...
     * @return 操作的结果
     */
    @RequestMapping(value = "verifyPassword", method = RequestMethod.POST, produces = RequestConstant.CONTENT_TYPE)
    @ResponseBody
    public String verifyPassword(HttpServletRequest request, PasswordVO passwordVO)
    {
        SessionVO sessionVO = (SessionVO) request.getAttribute(Constant.LOGININFO);

        return service.verifyPassword(sessionVO, passwordVO);
    }
}
