...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${path}/pages/repertory/qm-transferapprove.css"/>
</head>

<body>
<div class=" bodybox">
    <div class="header">
        <div class="react-but" onclick="qm_transferapprove.resetBut()">重置</div>
        <div class="time-box">
            ...
            <input id="d5222" class="Wdate" type="text"
                   onclick="WdatePicker( { onpicked:function(){qm_transferapprove.timeSeo();},maxDate:'#F{$dp.$D(\'d5222\') }'} )"/>
        </div>
        <div class="seo-sel" >
            <select  id="stataSeo" onchange="qm_transferapprove.stataSeo()">
                <option value="">全部</option>

            </select>
        </div>
        <div class="seo-sel" id="seoSelBox">
            <select id="seoSel" onchange="qm_transferapprove.getBranchRecord(this.value)">
                <option value="">全部</option>
            </select>
        </div>
    </div>
    ...
    <div class="paging">
        ...
        <div class="pagingright" onclick="qm_transferapprove.NextPage(this)">
            下一页
        </div>
        <div class="pagingmodle">
            <span id="pageleft">1</span>/<span id="pageright">1</span>
        </div>
        <div class="pagingleft" onclick="qm_transferapprove.NextPage(this)">
            上一页
        </div>
        <div class="paging-num-box" id="pagebox">
            列表显示:<span class="paging-num" onclick="qm_transferapprove.pageShowNum(this)">30</span>
            <span class="paging-num" onclick="qm_transferapprove.pageShowNum(this)">20</span>
            <span class="paging-num paging-checked" onclick="qm_transferapprove.pageShowNum(this)">10</span>
        </div>
    </div>
</div>
...
<script src="${path}/pages/repertory/qm-transferapprove.js"></script>
