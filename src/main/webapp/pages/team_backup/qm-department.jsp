...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${path}/pages/team/qm-department.css"/>
</head>
<body>
            ...
            <div class="qm-team Department">
                ...
                <div class="am-g qm-team-txt">
                    <div class=" am-u-sm-10">
                        ...
                        <div class=" qm-team-input">
                            <span class=" am-u-sm-1">部门名称:</span><input class=" am-u-sm-4 am-u-end"/>
                            <span class=" am-u-sm-1">负责人:</span><input class=" am-u-sm-4 am-u-end"/>
                        </div>
                        <div class=" qm-team-input">
                            <span class=" am-u-sm-1">部门人数:</span><input class=" am-u-sm-4 am-u-end"/>
                ...
                <div class="am-u-sm-10 qm-team1-box">
                    ...
                    <table class="am-table ">
                        ...
                        <tr>
                            ...
                            <td>
                                <select class="select-but" onchange="PromptSel(this)">

                                    <option value="">人事部</option>
                                    <option value="">业务部</option>
                                </select>
                                <select class="select-but">
